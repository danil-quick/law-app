...
class StateOpeningScreen extends StatefulWidget {
  _StateOpeningScreenState createState() => _StateOpeningScreenState();
}

class _StateOpeningScreenState extends State<StateOpeningScreen> {
  ...
  Future _loadData() async {
    ...
    final String url = baseUrl + 'stateOpening';
    ...
    if (response.statusCode == 200) {
      ...
      print('stateopening: ${items.toString()}');
    }
  }
  ...
  Future _searchData(String key) async {
    ...
    final String baseUrl = '${GlobalConfiguration().getString('api_base_url')}';
    final String url = baseUrl + 'searchStateOpening';
    final client = new http.Client();
    ...
    if (response.statusCode == 200) {
      ...
      print('searchStateOpening: ${items.toString()}');
    }
  }
  ...
  Widget build(BuildContext context) {
    ...
    final height =size.height;
    return Scaffold(
      appBar: AppBar(title: Text('STATE OPENING'),),
      drawer: AppDrawer(),
