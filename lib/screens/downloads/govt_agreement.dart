...
class GovtAgreementScreen extends StatefulWidget {
  _GovtAgreementScreenState createState() => _GovtAgreementScreenState();
}

class _GovtAgreementScreenState extends State<GovtAgreementScreen> {
  ...
  Future _loadData() async {
    ...
    final String url = baseUrl + 'govtAgreement';
    ...
    if (response.statusCode == 200) {
      ...
      print('govtAgreement: ${items.toString()}');
    }
  }
  ...
  Future _searchData(String key) async {
    ...
    final String baseUrl = '${GlobalConfiguration().getString('api_base_url')}';
    final String url = baseUrl + 'searchGovtAgreement';
    final client = new http.Client();
    ...
    if (response.statusCode == 200) {
      ...
      print('searchGovtAgreement: ${items.toString()}');
    }
  }
