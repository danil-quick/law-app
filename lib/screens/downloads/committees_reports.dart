...
class CommitteesReportsScreen extends StatefulWidget {
  _CommitteesReportsScreenState createState() => _CommitteesReportsScreenState();
}

class _CommitteesReportsScreenState extends State<CommitteesReportsScreen> {
  ...
  Future _loadData() async {
    ...
    final String url = baseUrl + 'committeesReports';
    ...
    if (response.statusCode == 200) {
      ...
      print('committeesReports: ${items.toString()}');
    }
  }
  ...
  Future _searchData(String key) async {
    ...
    final String baseUrl = '${GlobalConfiguration().getString('api_base_url')}';
    final String url = baseUrl + 'searchCommitteesReports';
    final client = new http.Client();
    ...
    if (response.statusCode == 200) {
      ...
      print('searchCommitteesReports: ${items.toString()}');
    }
  }
