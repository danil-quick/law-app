...
class GazettedActsScreen extends StatefulWidget {
  _GazettedActsScreenState createState() => _GazettedActsScreenState();
}

class _GazettedActsScreenState extends State<GazettedActsScreen> {
  ...
  Future _loadData() async {
    ...
    final String url = baseUrl + 'gazettedActs';
    ...
    if (response.statusCode == 200) {
      ...
      print('gazettedActs: ${items.toString()}');
    }
  }
  ...
  Future _searchData(String key) async {
    ...
    final String baseUrl = '${GlobalConfiguration().getString('api_base_url')}';
    final String url = baseUrl + 'searchGazettedActs';
    final client = new http.Client();
    ...
    if (response.statusCode == 200) {
      ...
      print('searchGazettedActs: ${items.toString()}');
    }
  }
