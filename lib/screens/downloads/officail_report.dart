...
class OfficailReportScreen extends StatefulWidget {
  _OfficailReportScreenState createState() => _OfficailReportScreenState();
}

class _OfficailReportScreenState extends State<OfficailReportScreen> {
  ...
  Future _loadData() async {
    ...
    final String url = baseUrl + 'officailReport';
    ...
    if (response.statusCode == 200) {
      ...
      print('officailReport: ${items.toString()}');
    }
  }
  ...
  Future _searchData(String key) async {
    ...
    final String baseUrl = '${GlobalConfiguration().getString('api_base_url')}';
    final String url = baseUrl + 'searchOfficailReport';
    final client = new http.Client();
    ...
    if (response.statusCode == 200) {
      ...
      print('searchOfficailReport: ${items.toString()}');
    }
  }
