...
class ParliamentChiefMemberScreen extends StatefulWidget {
  const ParliamentChiefMemberScreen(this.id);

  final String id;
  _ParliamentChiefMemberScreenState createState() => _ParliamentChiefMemberScreenState();
}

class _ParliamentChiefMemberScreenState extends State<ParliamentChiefMemberScreen> {
  ...
  Future _loadData() async {
    ...
    final String url = baseUrl + 'parliamentChiefMember';
    ...
    if (response.statusCode == 200) {
      ...
      print('parliamentChiefMember: ${items.toString()}');
      print(imageUrl);
    }
  } 
