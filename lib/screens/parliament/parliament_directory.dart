...
class ParliamentDirectoryScreen extends StatefulWidget {
  _ParliamentDirectoryScreenState createState() => _ParliamentDirectoryScreenState();
}

class _ParliamentDirectoryScreenState extends State<ParliamentDirectoryScreen> {
  ...
  Future _loadData() async {
    ...
    final String url = baseUrl + 'parliamentDirectory';
    ...
    if (response.statusCode == 200) {
      ...
      print('parliamentDirectory: ${items.toString()}');
      print(imageUrl);
    }
  } 
            ...
            children: [
              ...
              Container(
                ...
                child: Container(
                  ...
                  child: Row(
                    children: [
                      Text('Parliament Directory', style: TextStyle(fontWeight: FontWeight.bold),),
                    ],
                  ),
                )
              ),
